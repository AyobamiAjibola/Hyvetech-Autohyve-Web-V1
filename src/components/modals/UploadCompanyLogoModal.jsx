...
import { companyLogoAction, createPartnerSettingsAction } from "../../store/actions/partnerActions";
...
export default function UploadCompanyLogoModal({ setOpenProfile, openProfile, data }) {
                  ...
                  <div className="flex justify-center items-center flex-col">
                    ...
                    <div className="flex justify-between gap-5 mt-5">
                      ...
                      <AppBtn
                        ...
                        title="UPLOAD"
                        spinner={partnerReducer.companyLogoUploadStatus === 'loading'}
                      />
                    </div>
                  </div>
              </Form>
