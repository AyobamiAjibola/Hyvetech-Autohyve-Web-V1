...
interface IPartnerState {
  ...
  companyLogoUploadStatus: IThunkAPIStatus;
...
const partnerSlice = createSlice({
  ...
  reducers: {
    ...
    clearCompanyLogoUploadStatus(state: IPartnerState) {
      state.companyLogoUploadStatus = 'idle';
      state.companyLogoUploadSuccess = '';
      state.companyLogoUploadError = '';
    },
  },
  extraReducers: builder => {
    ...
    builder
      .addCase(companyLogoAction.pending, state => {
        state.companyLogoUploadStatus = 'loading';
      })
      .addCase(companyLogoAction.fulfilled, (state, action) => {
        state.companyLogoUploadStatus = 'completed';
        state.companyLogoUploadSuccess = action.payload.message;
      })
      .addCase(companyLogoAction.rejected, (state, action) => {
        state.companyLogoUploadStatus = 'failed';

        if (action.payload) {
          state.companyLogoUploadError = action.payload.message;
        } else state.companyLogoUploadError = action.error.message;
      });
